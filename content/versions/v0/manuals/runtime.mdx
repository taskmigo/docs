...
```mermaid
flowchart LR
  tab1["Tab 1 bootstrap"] --> tab1Binding["S42 + ja-JP"]
  tab2["Tab 2 bootstrap"] --> tab2Binding["S42 + ja-JP"]
```
...
```mermaid
flowchart TD
  profile["User profile language"] -->|"Bootstrap or explicit language change"| locale["Runtime binding locale"]
  locale -->|"Source of truth for this app instance"| evaluation["Translation + Expression evaluation"]
```
