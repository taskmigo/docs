...
A Site imports Applications. Only an Application may import Pages. Resources are never discovered by name, so a resource outside this graph cannot become part of the running Site.
