...
Translation catalogs are selected by locale. Policies are selected globally for each Site snapshot and cannot be imported. Workflow relationships are part of the [Workflow RFC](/versions/v0/manifests/v0-workflow).
