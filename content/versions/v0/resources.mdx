...
Translation catalogs are selected by locale. Policies are registered globally, target API path globs, are activated through Role attachments, and cannot be imported. Workflow relationships are part of the [Workflow RFC](/versions/v0/manifests/v0-workflow).
