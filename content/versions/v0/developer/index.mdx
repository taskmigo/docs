...
<Cards>
  ...
  <Card
    ...
    description='Schema ownership, migrations, constraints, transactions, concurrency, indexing, retention, and PostgreSQL verification.'
  />
  <Card
...
| Database architecture and schema evolution  | Defined       | [Database](/versions/v0/developer/database)                     |
