...
<Callout title='RFC — do not implement as delivered foundation behavior' type='warning'>
  This page translates the proposed [Workflow contract](/versions/v0/manuals/manifests/v0-workflow) into an implementation
  design. The contract may still change before Workflow enters delivery.
</Callout>
