...
Taskmigo resolves a complete candidate graph. Translation changes also affect Sites using the corresponding locale catalog. See [Resource resolution](/versions/v0/resources#resolution).
