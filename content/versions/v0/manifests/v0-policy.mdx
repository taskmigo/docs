...
<TypeTable
  type={{
    ...
    'spec.target': {
      type: 'RequestTarget | DataTarget | UITarget',
      required: true,
...
<TypeTable
  type={{
    ...
    'request.path': {
      type: 'AbsolutePathPattern',
      required: true,
      description: 'Matches a Page or API route.',
    },
    'data.resource': {
      type: 'string',
      required: true,
      description: 'Selects the logical data resource whose query or projection is governed.',
    },
    'data.operation': {
      type: '"read"',
      required: true,
      description: 'Applies the policy while records are read.',
    },
    'data.fields': {
      type: 'string[]',
      description: 'Limits the decision to the listed logical fields; omission governs whole records.',
    },
    'ui.application': {
      type: 'string',
      description: 'Selects one Application by name.',
    },
    'ui.page': {
      type: 'string',
      description: 'Selects one Page by name.',
    },
    'ui.componentId': {
      type: 'string',
...
<TypeTable
  type={{
    Expression: {
      type: 'string',
      description: 'Calls one available policy predicate function and returns one database-capable condition.',
    },
    and: {
      type: 'PolicyCondition[]',
