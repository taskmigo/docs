...
<TypeTable
  type={{
    ...
    timeout: { type: 'duration', description: 'Limits one Action attempt.' },
    retry: { type: 'object', description: 'Configures retry behavior for an Action step.' },
    'retry.attempts': { type: 'integer', description: 'Limits the total number of Action attempts.' },
    'retry.delay': { type: 'duration', description: 'Waits this long between Action attempts.' },
    continueOnError: {
      type: 'boolean',
