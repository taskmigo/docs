...
spec:
  ...
  steps:
    ...
    confirm:
      ui:
        component: component/employee-confirmation
        props:
...
<TypeTable
  type={{
    'spec.meta': { type: 'object', required: true, description: 'Information used to present the Workflow.' },
    'spec.meta.title': {
...
approve:
  ui:
    component: component/approval-form
    props:
